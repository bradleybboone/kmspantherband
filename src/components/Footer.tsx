        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-lighter">
              ...
              <li className="pt-2">
                <a href="tel:2812817900" className="hover:text-white transition-colors">
                  (281) 727-3500
                </a>
              </li>
            </ul>
          ...
          {/* Follow Us */}
          <div>
            <h3 className="text-lg font-display font-medium mb-4 text-white !text-white">FOLLOW US</h3>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-lighter hover:text-white transition-colors">
